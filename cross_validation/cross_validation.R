...
sample = dataset[sample(nrow(dataset),17),]; rmse = rmse(sample$Validity, sample$SimpleModel); lm_model = lm(sample$Validity ~ sample$SimpleModel); rsquared = summary(lm_model)$r.squared; print(c(rmse, rsquared))
